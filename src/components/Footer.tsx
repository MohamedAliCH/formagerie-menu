    ...
    <div className="max-w-6xl mx-auto px-5 py-14">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <Logo className="[&_span]:text-ivory-cheese" />
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-sans font-semibold tracking-[0.2em] uppercase text-muted-olive">
            Contact
          </h4>
          <div className="space-y-2 text-sm">
            <a href="tel:+21623329295" className="flex items-center gap-2 text-ivory-cheese hover:text-roasted-crimson transition-colors">
              <Phone className="w-3.5 h-3.5 text-roasted-crimson" />
              +216 23.329.295
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 text-ivory-cheese hover:text-[#25D366] transition-colors"
            >
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-9 h-9 flex items-center justify-center border border-ivory-cheese/15 hover:border-roasted-crimson text-ivory-cheese hover:text-roasted-crimson transition-all"
              aria-label="Facebook"
            >
          ...
          <p className="text-xs text-tile-pattern">@fromagerie.ilef</p>
        </div>
      </div>

      <div className="mt-10 pt-6 border-t border-ivory-cheese/10 text-center text-xs text-tile-pattern">
